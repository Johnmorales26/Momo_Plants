package com.johndev.momoplantsparent.ui.profileModule.view
...
import com.johndev.momoplantsparent.ui.mainModule.MainActivity.Companion.profileViewModel
    ...
    private fun setupToolbar() {
        binding.toolbar.setOnMenuItemClickListener { menuItem ->
            when (menuItem.itemId) {
                R.id.action_about -> {
                    printMessage(Pair(R.string.soon_available_option, ToastType.Info), context = requireContext())
                    true
                }
