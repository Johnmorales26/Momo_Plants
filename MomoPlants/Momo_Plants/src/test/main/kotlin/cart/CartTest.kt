...
class CartTest {
    ...
    fun findItem_existsItem_returnsItem() {
        ...
        cart.addItem(ItemEntity(PlantsDatabase.getAllPlants()[8], 5))
        cart.addItem(ItemEntity(PlantsDatabase.getAllPlants()[5], 5))
        cart.addItem(ItemEntity(PlantsDatabase.getAllPlants()[10], 5))
        cart.addItem(ItemEntity(PlantsDatabase.getAllPlants()[15], 5))
        cart.addItem(ItemEntity(PlantsDatabase.getAllPlants()[20], 5))
        cart.addItem(ItemEntity(PlantsDatabase.getAllPlants()[25], 5))
        cart.addItem(ItemEntity(PlantsDatabase.getAllPlants()[30], 5))
    ...
    fun updateItem_itemExists_itemUpdated() {
        ...
        cart.addItem(ItemEntity(PlantsDatabase.getAllPlants()[5], 10))
        cart.addItem(ItemEntity(PlantsDatabase.getAllPlants()[0], 5))
