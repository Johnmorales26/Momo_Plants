...
import com.johndev.momoplants.databinding.ItemChatBinding
import java.text.DateFormat
import java.util.Date

class ChatAdapter(
    private val messageList: MutableList<MessageEntity>,
        ...
        holder.apply {
            ...
            with(binding) {
                ...
                var backgroundMessage =
                    ContextCompat.getDrawable(context, R.drawable.background_chat_client)
                var textColor = ContextCompat.getColor(context, R.color.md_theme_light_onSecondary)
                ...
                if (!message.isSentByMe()) {
                    ...
                    backgroundMessage =
                        ContextCompat.getDrawable(context, R.drawable.background_chat_support)
