...
class ChatActivity : AppCompatActivity(), OnChatListener {
    ...
    private fun setupObservers() {
            ...
            order?.let {
                ...
                chatViewModel.setupRealtimeDatabase(
                    ...
                    updateScroll = {
                        ...
                        printErrorToast(R.string.chat_error_load,  context = this)
                    }
                )
            }
        }
        ...
        chatViewModel.msg.observe(this) {
            if (it == R.string.chat_order_not_found) printErrorToast(it, context = this) else printNormalToast(it, context = this)
        }
    }
