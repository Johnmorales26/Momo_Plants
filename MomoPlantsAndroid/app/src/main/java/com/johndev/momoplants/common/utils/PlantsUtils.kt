...
fun printToastMsg(msgRes: Int, context: Context) = Toast.makeText(context, context.getText(msgRes), Toast.LENGTH_SHORT).show()

fun printToastWithStringMsg(msgRes: Int, value: String, context: Context) = Toast.makeText(context, context.getString(msgRes, value), Toast.LENGTH_SHORT).show()

fun printSnackbarMsg(view: View, msgRes: Int, context: Context) = Snackbar.make(view, context.getString(msgRes), Snackbar.LENGTH_SHORT).show()
...
fun Toolbar.setupNavigationTo(fragment: Fragment, fragmentManager: FragmentManager) {
    setNavigationOnClickListener {
        openFragment(fragment = fragment, fragmentManager = fragmentManager, containerId = R.id.container)
    }
}
...
fun getAllPlants() = listOf(
    PlantEntity(name = "Monstera deliciosa",
        ...
        stock = 10,
        quantity = 0),
    PlantEntity(name = "Ficus elastica",
        ...
        stock = 5,
        quantity = 0),
    PlantEntity(name = "Pilea peperomioides",
        ...
        stock = 15,
        quantity = 0),
    PlantEntity(name = "Dracaena marginata",
        ...
        stock = 8,
        quantity = 0),
    PlantEntity(name = "Sansevieria trifasciata",
        ...
        stock = 20,
        quantity = 0),
    PlantEntity(name = "Calathea orbifolia",
        ...
        stock = 4,
        quantity = 0),
    PlantEntity(name = "Alocasia macrorrhiza",
        ...
        stock = 7,
        quantity = 0),
    PlantEntity(name = "Pachira aquatica",
        ...
        stock = 12,
        quantity = 0),
    PlantEntity(name = "Echeveria elegans",
        ...
        stock = 25,
        quantity = 0),
    PlantEntity(name = "Haworthia fasciata",
        ...
        stock = 30,
        quantity = 0),
    PlantEntity(name = "Strelitzia reginae",
        ...
        stock = 5,
        quantity = 0),
    PlantEntity(name = "Aglaonema commutatum",
